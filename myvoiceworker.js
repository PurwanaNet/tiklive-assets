	...
	const welcomemsg = [
		...
		"Kompetisi tap-tap layar akan berakhir setiap 10 menit, @{usernames}! Ayo, tunjukkan kecepatanmu!",
		"Selamat bergabung, @{usernames}! Jangan lupa follow dan tap-tap layar, ya!",
		"Mari sambut hangat @{usernames} di TikTok Live kita hari ini!",
		"Hi @{usernames}! Selamat datang di live yang penuh keseruan ini!",
		"Terima kasih sudah hadir, @{usernames}! Ayo, ramekan live ini dengan tap-tap layar yang semakin banyak!",
		"Selamat datang di TikTok Live, @{usernames}! Jangan lupa kunjungi CLSRM dot purwana dot net ya!",
		"Hai @{usernames}! Tap tap koin untuk donasinya yang berharga!",
		"Yuk, dukung live ini dengan memberikan kotak harta kepada @{usernames}!",
		"Kompetisi tap-tap layar setiap 10 menit ya, @{usernames}! Ayo, semangat!",
		"Selamat bergabung, @{usernames}! Mari buat live ini makin meriah!",
		"Hi @{usernames}! Semangat untuk live seru kita hari ini!",
		"Terima kasih, @{usernames}, sudah hadir di live ini! Ayo, tap-tap layar sebanyak mungkin!",
		"Selamat datang, @{usernames}! Jangan lupa follow dan bagikan live ini!",
		"Mari kita berikan sambutan hangat kepada @{usernames} di TikTok Live kita!",
		"Hi @{usernames}! Ayo, buat live ini makin seru dengan komentar dan tap-tap layarmu!",
		"Terima kasih atas kehadiranmu, @{usernames}! Dukunganmu sangat berarti!",
		"Selamat datang di live kita, @{usernames}! Yuk, kunjungi CLSRM dot purwana dot net!",
		"Hai @{usernames}! Yuk kasih mawar-mawarnya yang cantik!",
		"Yuk, beri @{usernames} kotak harta agar live ini semakin meriah!",
		"Kompetisi tap-tap layar akan berakhir setiap 10 menit, @{usernames}! Siap-siap ya!",
		"Selamat bergabung, @{usernames}! Mari kita rayakan live ini dengan semangat!"
		];
